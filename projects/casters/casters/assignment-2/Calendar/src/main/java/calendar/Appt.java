...
public class Appt {
     ...
     */
    private void isValid() {//SEAN: startYear not validated, could be negative
    	...
    	if(startHour<0 || startHour>24)
        	...
        	if(startMinute<0 || startMinute>60)
            	...
            	if(startDay<1 || startDay>NumDaysInMonth)
                	...
                	if(startMonth<1 || startMonth>13)//SEAN: bug, 12 months not 13
                		this.valid=false;
                	else
                		this.valid=true;
    }
     ...
     */
    /*SEAN: this function's parameters aren't validated, so they could be negative.
     * This might not actually cause problematic behavior though, as long as they cause the same behavior as the input '0'
     * Check for booleans written as ==0, instead of >=0
     */
